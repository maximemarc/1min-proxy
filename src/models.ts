...
// Audio models
export const AUDIO_MODELS: Record<string, string> = {
  // TTS
  'tts-1': 'tts-1',
  'tts-1-hd': 'tts-1-hd',
 ...
 */
export function mapModel(model: string, category: ModelCategory = 'chat'): string {
  const maps: Record<ModelCategory, Record<string, string>> = {
    chat: CHAT_MODELS,
    image: IMAGE_MODELS,
    audio: AUDIO_MODELS,
    video: VIDEO_MODELS,
 ...
 */
export function getAllModels(): Record<ModelCategory, string[]> {
  return {
